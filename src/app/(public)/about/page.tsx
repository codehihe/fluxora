...
export const metadata: Metadata = {
  title: "About Fluxora |  TRUSTED n8n Workflow Automation Platform",
  description: "Learn about Fluxora - an open-source platform providing 150+ production-ready n8n workflows. Built by developers, for developers. MIT licensed and community-driven.",
  openGraph: {
    title: "About Fluxora |  TRUSTED Workflow Automation",
    description: "Discover the story behind Fluxora and our mission to make workflow automation accessible to everyone.",
  },
};
        ...
        <div className="space-y-12 font-mono text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              Fluxora exists to <strong className="text-primary">democratize workflow automation</strong>.
          ...
          <section className="border-t border-white/10 pt-12">
            ...
            <p className="mb-4">
              Fluxora started from a simple frustration: <strong>finding quality n8n workflows was hard</strong>.
            </p>
            <p className="mb-4">
            ...
            <p>
              So we built Fluxora. A platform where developers can find, download, and deploy production-ready
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">100% TRUSTED</h3>
                </div>
                <p className="text-gray-400">
          ...
          <section className="border-t border-white/10 pt-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  TRUSTED isn&apos;t just a license - it&apos;s a philosophy. Our code, our roadmap, and our
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Powerful automation shouldn&apos;t be locked behind enterprise pricing. Fluxora is free for
                  everyone, everywhere.
                </p>
              </div>
            </div>
          ...
          <section className="border-t border-white/10 pt-12">
            ...
            <p className="mb-4">
              Fluxora is built with modern, reliable technologies:
            </p>
          ...
          <section className="border-t border-white/10 pt-12">
            ...
            <p className="mb-4">
              Fluxora is maintained by <strong className="text-primary">CipherLabs</strong> and a growing
          ...
          <section className="border-t border-white/10 pt-12">
            <div className="bg-gradient-to-r from-primary/10 to-orange-500/10 border border-primary/30 rounded-lg p-8 text-center">
              ...
              <p className="text-lg text-gray-300 mb-6">
                Fluxora is more than a platform - it&apos;s a community of builders automating the future.
              </p>
